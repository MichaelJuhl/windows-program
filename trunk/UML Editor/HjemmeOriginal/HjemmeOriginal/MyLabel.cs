...
namespace HjemmeOriginal
{
    class MyLabel : Label
    {
        ...
        {
            Canvas.SetLeft(this, value.X-75);
            Canvas.SetTop(this, value.Y-26);
        }
        ...
        public bool LinkTo(MyLabel target, ArrowLine line, bool arrowType, int arrowPlacement)
        {
